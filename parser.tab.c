...
{
      10,     0,    -1,    11,    -1,    11,     3,    12,    -1,    12,
      -1,    12,     4,    13,    -1,    13,    -1,     7,    -1,     8,
      -1,     5,    11,     6,    -1
};
...
{
  "$end", "error", "$undefined", "PLUS", "MULT", "OPEN", "CLOSE", "'a'",
  "'b'", "$accept", "S", "E", "T", "F", YY_NULL
};
#endif
...
{
       0,   256,   257,   258,   259,   260,   261,    97,    98
};
# endif
